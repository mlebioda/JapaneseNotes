...
(はな)
#wc 話す（はな）- talk
#w 友達と話す（ともだち、はな）- to talk with friend


(はなし)
#w 話 (をする)（はなし）- rozmowa, talk noun (+verb)
#w 母と話をする（はは、はなし) - to talk to mother (verb)

(わ)
#w 会話（かいわ）- conversation
#w 手話（しゅわ）- sign language
...
(きこえる)
#wc 聞こえる（き) - to be heard, not actively hear
#w 音が聞こえる(おと、き）- hear the voice
...
(おこなう)
#wc 行う（おこなう）- wykonywać, przeprowadzać, realizować (czynność, wydarzenie, plan, formalny)
#w 授業を行う（じゅぎょう、おこな) - to give (conduct) a lesson
...
(こない)
#w 友達が来ない（ともだち、こ） - my friend didn't come

(きます)
#w 先生が来ます（せんせい、き）- teacher will come
...
(だす)
#wc 出す（だ）- wyjmować, wyciągać, wystawiać, wydawać, uruchamiać / wysyłać (sprawić, że coś „wyjdzie na zewnątrz”)
#w 水を出す（みず、だ）- to turn on water

(しゅつ)
#w 外出（がいしゅつ）- to go out Noun
#w 外出です（がいしゅつ） – jestem poza domem / wyszedłem
...
(いれる)
#wc 入れる（い）- to put in
#w カバンに本を入れる（い）- to put the book to the bag
...
#wc 食べる - to eat
#w 食べ物 - food (casual)
#w 肉を食べる（にく、た）- to eat meat

(しょく)

#w 食事(する)(しょくじ) - meal, little formal V/N
#w 食品（しょくひん）- food, artykul sporzywczy/ food product
...
(いん)
#w 飲食（いんしょく）- eat and drink (regulaminy itp)
...
(りつ)
#w 国立大学（こくりつだいがく）- national university

(りっ)
#w 立食パーティー（りっしょく）- a stand up meal party
