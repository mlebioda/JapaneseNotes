...
**(あと)**
#w 後で、コーヒーを飲む - to drink coffee later


**(ご)**
#w 前後（ぜんご) - back and forth (tam i z powrotem)
午後（ごご）- po południu
...
**(う)**
#wc 右折（うせつ) - turn right (noun can be verb)
...
**(あ)**
#w エレベータが上がる（あ) - an elevator goes up
#wc 上がる（あ）- go up (object rise)
...
**(さ)**
#w エレベーターが下がる（さ) - elevator goes down
#wc 下がる(さ) - go down (object)
