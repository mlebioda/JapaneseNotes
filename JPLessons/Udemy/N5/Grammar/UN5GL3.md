TARGET DECK: N5-Udemy::N5-Udemy-Grammar::UN5GL3-where-is a meeting-room

#w 会議室は どこに ありますか (かいぎしつ)- where is a meeting room

#w 会議室（かいぎしつ) - conference room


#w 場所を聞くことと答えを理解することができる（ばしょ,き, こた, りかい) - Be able to ask and understand locations

#w 聞くこと（きく）- czynność pytania, forma rzeczownikowa od czasownika

#w **答え（こたえ）** - odpowiedź

#w **理解（りかい）** - rzeczownik: „zrozumienie”.  
#w **理解する（りかいする）** - formalne, świadome, intelektualne „rozumieć, pojmować”.

#w ここ、そこ、あそこ　の使い方（つかいかた）-  how to use koko, soko and asoko

#w 百以上の数字の読み方（ひゃくいじょう、すうじ） - „numbers 100 and above”

#w **以上（いじょう）** - „i więcej”, „powyżej”

#w 会話（かいわ）- conversation
## vocabulary

#w 海外（かいがい) - overseas
#w -部（ぶ）- departament (in an organization)
#w 海外部（かいがいぶ) - overseas department
#w 営業部（えいぎょうぶ) - sales department
#w 人事部（じんじぶ）- personel department

#w 事務（じむ) - office work

#w 手帳（てちょう）- pocket notebook
#w ノット - notebook

#w 名刺（めいし）- business card 

#w 万年筆（まんねんひつ）- fountain pen, wieczne pióro
#w 鉛筆　（えんぴつ）- pencil
#w ポールペン - ballpoint pen

#w パソコン - personal computer
#w コンピューター computer
...
#w 食堂（しょくどう) - dining hall, cafeteria
#w 部屋（へや) - room

#w 受付（うけつけ) - reception desk

#w エレベーター　- elevator

#w 自動販売機（じどうはんばいき）- vending machine
#w 課長（かちょう) - manager
#w 部長（ぶちょう) - general manager
#w 社長（しゃちょう) - CEO

#w 億（おく) - on hundred milion

#w 海外部は三階です（かいがい、さんがい）- The overseas department is on the third floor
#w 部長の部屋はあそこです（ぶちょう、へや）- the general manager's room is over there

#w 受付は一階です（うけつけ、いっかい) - The reception desk is on the first floor

#w 自動販売機があります（じどうはんばいき) - there is a vending machine
#w 花があります (はな) - there is a flower

## Expressions ひょうげん

#w ひょうげん - expressions

#w しつれいします - excuse me (when entering to room such a work place, office, ceo office and factory, interview) people reply, hai, douzo

#w あのう - well ,umm(start conversation, when hesitate to do something)

#w あのう、らんさんですか - Um, are you Lan?

#w すみません - excuse me, pardon, im sorry, thank you
...
#w 三枚（さんまい）- 3 rzeczy płaskie 
#w 四枚（よんまい）- 4 rzeczy płaskie 
#w 五枚（ごまい）- 5 rzeczy płaskich
#w 六枚（ろくまい）- 6 rzeczy płaskich
#w 七枚（ななまい）- 7 rzeczy płaskich
#w 八枚（はちまい）- 8 rzeczy płaskich
#w 九枚（きゅうまい）- 9 rzeczy płaskich
#w 十枚（じゅうまい）- 10 rzeczy płaskich

#w 何枚（なんまい）- how many thin objects?
...
#w おてあらいはどちらですか - where is toilet?
#w 部長はどちらにいますか - where is the general manager?


|              | proximiti to the speaker | proximity to the listener | distance from both | indefinite pronoun |
| ------------ | ------------------------ | ------------------------- | ------------------ | ------------------ |
| Thing        | これ                       | それ                        | あれ                 | どれ                 |
...
##### Examples
- あそこに椅子と机があります（いす、つくえ) - There is a chair and desk over there
- エレベーターの　となり に　トイレがあります - there is a restroom next to the elevator

- 会議室にだれがいますか (かいぎしつ) - who is in the meeting room?
...
##### Examples
- あの写真はアンドさんの机の上にあります（しゃしん、つくえ）- That picture is on MR Ando desk
- 自動販売機は受付隣にあります（じどうはんばいき、うけつけ, となり) - The vending machine is next to the reception desk 

- 社長はどこにいますか（しゃちょう) - Where is the CEO
- 社長はあの部屋にいます（しゃちょう、へや) - Ceo is in that room
...
#w あそこに椅子と机があります（いす、つくえ) - There is a chair and desk over there
#w エレベーターの　となり に　トイレがあります - there is a restroom next to the elevator

#w 会議室にだれがいますか (かいぎしつ) - who is in the meeting room?
#w 会議室に部長がいます（かいぎしつ、ぶちょう）- The general manager is in the meeting room

#w あの写真はアンドさんの机の上にあります（しゃしん、つくえ）- That picture is on MR Ando desk
#w 自動販売機は受付隣にあります（じどうはんばいき、うけつけ, となり) - The vending machine is next to the reception desk 

#w 社長はどこにいますか（しゃちょう) - Where is the CEO
#w  社長はあの部屋にいます（しゃちょう、へや) - Ceo is in that room
...
#w 十万（じゅうまん) - 100 000
#w 百万（ひゃくまん）- 1 000 000
#w 一千万（いっせんまん）- 10 000 000
#w 一億（いちおく）- 100 000 000
