TARGET DECK: N5-Udemy::N5-Udemy-Grammar::UN5GL9-This-restaurant-is-delicious-and-very-famous

#w この店は美味しくてとても有名ですよ（店、おいし、ゆうめい) - This restaurant is delicious and very famous

#w レストランで注文ができること（ちゅうもん）- Being able to order food in restaurant

## ごい

#w ひとつ - one (used when counting things)  
#w ふたつ - two (used when counting things)  
#w 名（めい）- polite counter suffix for people  #k


#wp 有名（ゆうめい）- famous  #k
#w 有名な人（ゆうめい、ひと）- famous person #k
#w 有名な映画（ゆうめい、えいが）- famous movie #k

---

#wp 賑やか（にぎやか）- lively / busy  (lot of voices can be heard)
#w 賑やかな町（にぎ、まち）- a lively town #k
#w 賑やかな道（にぎ、みち）- busy street #k

#wp 静か（しずか）- quiet  
#w 静かな図書館（しず、としょかん）- quiet library #k
#w 静かな夜（しずか、よる) - a quiet night


---

#wp 便利（べんり）- convenient  
#w 私の家は便利な所にあります（べんり、ところ) - My home is at a convenient place #k


#wp 不便（ふべん）- inconvenient   
#w 私の家は不便な所にあります（ふべん、ところ) - My home is at a convenient place #k


---

#w 場所（ばしょ）- place (specific physical) #k
#w 所（ところ）- place (overall, physical and abstract) #k

---

#wp 丈夫（じょうぶ）- strong / solid /durable
#w このカバンはとても丈夫です（じょうぶ）- This bag is very durable

#w 大丈夫（だいじょうぶ）- all right/OK

---

#wp 真面目（まじめ）- serious / honest  #k
#w 真面目な人（まじめ、ひと）- a serious person


#wp 立派（りっぱ）- fine / respectable/wspanialy, imponujący (lepszy niz いい) #k
#w 立派な人（りっぱ、ひと）- a fine peroson
...
#w そば - soba (Japanese buckwheat noodles)  
#w うどん - udon (Japanese thick white noodles)  
#w 牛丼（ぎゅうどん）- beef rice bowl  #k
#w 焼肉（やきにく）- yakiniku (Japanese grilled meat) #k  
...
#w 野菜（やさい）- vegetable  
#w 焼きそば（やきそば）- yakisoba / fried noodles  
#w カレー（ライス）- curry  
#w ピザ - pizza  
#w ハンバーガー - hamburger  
#w サンドイッチ - sandwich  
...
#w 蜜柑（みかん）- tangerine  / mandarynka
#w 梨（なし）- pear  


#w 定食（ていしょく）- set meal  #k
#w 天ぷら定食（てん、ていしょく）- #k tenpura set
#w 焼肉定食（やきにく、ていしょく）- #k jp grilled meat set


#w ウェイトレス - waitress

#w (ご)注文（する）（ちゅうもん）- order / to order  #w 
#w 食事を注文する（しょくじ、ちゅうもん）- to order food
#w 何を注文しますか（なに、ちゅうもん）- what do you order
#w すしを注文しました（ちゅうもん）- I ordered sushi
...
#w 貨幣（かへい）- currency
#w 日本の貨幣（かへい）- japanese currency

#w レストラン - restaurant  


#w 時（とき）- time  #w 
#w いそがしい時（とき）- bussy time #k
#w 仕事の時 (とき) - at work #k 


#w ミス - mistake  

#wc 生活 (する）（せいかつ）- life / to live 　（prowadzic zycie, miec styl zycia) #k
#w 日本の生活は楽しいです（せいかつ、たの）- japanese life is fun #k
#w 東京で生活します（とうきょう、せいかつ）- i live in tokio #k
#w あの人は仕事をしません。生活はたいへんです - that person doesn't work, life is hard

#wc 起きる（おきる）- to get up
...
#w こちら/あちら へどうぞ - this way/over there please
#w 部屋へどうぞ（へや）- please enter the room

#w ご注文は（ごちゅうもん） - may I take your order  #k
#w ご注文は何なさいますか（ごちゅうもん、なに）- May I take your order? (very polite way)

#w お願いします（おね） - please  (orders, ask for favour)
#w 紅茶一つ、コーヒー 一つ をおねがいします（こうちゃ,ひとつ) - one black tea and one coffee, please
#w コピー  を おおねがいします - please copy this

#w 少々お待ちください（しょうしょうおまちください） - please wait a moment #k


#w お会計はご一緒ですか、別々ですか（おかいけい,いっしょ、べつべつ） - are you paying together or separately  #k
...
Do **bardzo wielu rzeczy**, szczególnie gdy są:
- małe,
- nieliczne (liczenie <10)
- niespecyficzne co do kształtu,
- albo nie pamiętasz licznika właściwego.
...
#w 一つ（ひとつ）- one item #counter  
#w 二つ（ふたつ）- two items #counter  
#w 三つ（みっつ）- three items #counter  
#w 四つ（よっつ）- four items #counter  
#w 五つ（いつつ）- five items #counter  
#w 六つ（むっつ）- six items #counter  
#w 七つ（ななつ）- seven items #counter  
#w 八つ（やっつ）- eight items #counter  
#w 九つ（ここのつ）- nine items #counter  
#w 十（とお）- ten items #counter

#w いくつ - how many (dla) ひとつ...
#w つくえの上にりんごがいくつありますか（うえ) - How many apples are on the desk?

#w 今日は母は(二つ**の**リンゴを/リンゴを２つ）買いました - #k Today, my mother bought 2 apples (2 kolejnosci czytania liczba->produkt, produkt->liczba)

Order
Place + Thing (が) + number + arimasu

#w 机の上に りんごが 五つあります（つくえ、うえ、いつつ）- There are 5 apples on the desk

### 個 (こ) - small things counter

- glownie male rzeczy >10

#w **一個（いっこ）- one small thing** #counter  
#w 二個（にこ）- two small things #counter  
#w 三個（さんこ）- three small things #counter  
#w 四個（よんこ）- four small things #counter  
#w 五個（ごこ）- five small things #counter  
#w **六個（ろっこ）- six small things** #counter  
#w 七個（ななこ）- seven small things #counter  
#w **八個（はっこ）- eight small things** #counter  
#w 九個（きゅうこ）- nine small things #counter  
#w 十個（じっこ / じゅっこ）- ten small things #counter

#w 十一個（じゅういっこ）- 11 small items #counter  
#w 十六個（じゅうろっこ）- 16 small items #counter  
#w 十八個（じゅうはっこ）- 18 small items #counter

#w 二十個（にじゅっこ / にじゅうこ）- 20 small items #counter  
#w 二十一個（にじゅういっこ）- 21 small items #counter  
#w 二十六個（にじゅうろっこ）- 26 small items #counter  
#w 二十八個（にじゅうはっこ）- 28 small items #counter

#w 三十個（さんじゅっこ / さんじゅうこ）- 30 small items #counter  
#w 四十個（よんじゅっこ / よんじゅうこ）- 40 small items #counter  
#w 五十個（ごじゅっこ / ごじゅうこ）- 50 small items #counter
...
#w キャンディーを四個（よんこ）もらう - receive four candies  
#w みかんを五個（ごこ）食べた - ate five mandarins  
#w 石（いし）を六個（ろっこ）集める - collect six stones  
#w クッキーを七個（ななこ）焼く - bake seven cookies  
#w 箱（はこ）を八個（はっこ）運ぶ - carry eight boxes  
#w ボタンを九個（きゅうこ）付ける - attach nine buttons  
#w チョコを十個（じゅっこ）買った - bought ten chocolates (pralinki, nie plaskie)

---

### 名 (めい) - counter for people (politwe)

#w 二名（にめい） - two people (polite) #k  
#w 三名（さんめい） - three people (polite) #k  
#w 四名（よんめい） - four people (polite) #k  
#w 五名（ごめい） - five people (polite) #k  
#w 六名（ろくめい） - six people (polite) #k  
#w 七名（ななめい） - seven people (polite) #k  
#w 八名（はちめい） - eight people (polite) #k  
#w 九名（きゅうめい） - nine people (polite) #k  
#w 十名（じゅうめい） - ten people (polite) #k

#w 十五名（じゅうごめい） - fifteen people (polite) #k  
#w 二十三名（にじゅうさんめい） - twenty-three people (polite) #k

#w 二十名（にじゅうめい） - twenty people (polite) #k  
#w 三十名（さんじゅうめい） - thirty people (polite) #k  
#w 四十名（よんじゅうめい） - forty people (polite) #k  
#w 五十名（ごじゅうめい） - fifty people (polite) #k  
#w 六十名（ろくじゅうめい） - sixty people (polite) #k  
#w 七十名（ななじゅうめい） - seventy people (polite) #k  
#w 八十名（はちじゅうめい） - eighty people (polite) #k  
#w 九十名（きゅうじゅうめい） - ninety people (polite) #k  
#w 百名（ひゃくめい） - one hundred people (polite) #k

#w 何名(さま)ですか（なんめい）- how many people (polite, and more polite) #k
...
- Non-past
	- affirmative
		- な形容詞 + です
			- しずかです 
	- negation
		- な形容詞 + ではありません ( more polite)
			- 静かではありません - is not quiet
		- な形容詞 + じゃありません (less polite)
			- 静かじゃありません - is not quiet
- Past
	- affirmative
		- な形容詞 + でした
			- 賑やかでした（にぎ）- was lively
	- negation
		- な形容詞 + ではありませんでした (more polite)
			- 賑やかではありませんでした（にぎ）- wasn't lively (more polite)
		- な形容詞 + じゃありませんでした (less polite)
			- 賑やかじゃありませんでした（にぎ）- wasn't lively (less polite)
- Adverb
	- affirmative
		- Nは + な形容詞 + に + V
			- しずかに 勉強する
...
#w にぎやかではありません - is not lively (more polite)
#w にぎやかじゃありません - is not lively (less polite)

#w 賑やかでした（にぎ）- was lively
#w きれいではありませんでした - wasn't clean (more polite) 
#w きれいじゃありませんでした - wasn't clean (less polite)

#w しずかに 勉強する - study quietly
#w 妹は静かに寝ています（いもうと、しず、ね） - my sister is quietly sleeping
#w べつべつに会計します（かいけい） - we will pay separately
#w 山田さんは真面目に働いています（やまだ、まじめ、はたら） - Mr. Yamada works hard
### 2. N＋なadj + です - something is...

Structure
- N＋なadj + です/か
	- 私の高校の先生は真面目です（こうこう、まじめ) - my high school teacher is serious

#w 私の高校の先生は真面目です（こうこう、まじめ) - my high school teacher is serious
#w 私は昨日ひま ではありませんでした - I didn't have much free time yesterday
#w この町はとてもにぎやかです（まち） - this town is very busy
#w あそこは有名ではありません（ゆうめい） - it is not famous there
#w 先週の仕事は大変でした（せんしゅう、しごと、たいへん） - last week's work was difficult
#w あのホテルはあまりきれいではありませんでした  - that hotel wasn't very clean  
...
#w あれは丈夫な建物です（じょうぶ、たてもの） - that is a solid building

### 5.  Nは + なadj で - AND

Structure: （Both positive, both negative)
- Nは + なadj1 で + なadj2....
	- 真面目で立派な人です（はじめ、りっぱ）- He is a serious and respectable person
- N は いadv + て + なadj + で .....
	- この部屋は広くて しずかで安いです(へや、やす) - The room is very big, quiet and cheap

- FOR conennecting positive and negative use (BUT)
	- .... が ....
		- うちは駅から遠いですが静かです(とおい、しず) - My house is far from the station but is quiet
...
- N1 は どんな N2 ですか - What skind/ort of N2 is N1?
	- 山田さんはどんな人ですか（やまだ、ひと） - what kind of person is Mr. Yamada

#w A: 山田さんはどんな人ですか（やまだ、ひと）B: おもしろい人です（ひと）- A:what kind of person is Mr. Yamada B: he is an interesting person

#w 秋葉原はどんな所ですか（ところ）B: とてもにぎやかな 所です - A: What kind of place is Akihabara? B: Its very busy place
...
Structure
- P1....から.... P2 - Because P1..... P2
	- きょうは早く帰りますから、いっしょに映画を見ましょう（はや、かえ、えいが、み） - because I will come back early today, let's watch a movie together
- P1....から.... P2 - P2 because P1
	- きょうは早く帰りますから、いっしょに映画を見ましょう（はや、かえ、えいが、み） - Lets watch a movie together because I will returen back early today

#w きょうは早く帰りますから、いっしょに映画を見ましょう（はや、かえ、えいが、み） - because I will come back early today, let's watch a movie together

#w 天気がいいですから、散歩しましょう（てんき、さんぽ） - because it is nice weather, let's go for a walk

#w 明日早く起きますから、今晩早く寝ます（あした、はや、お、こんばん、はや、ね） - because I will get up early tomorrow, I will sleep early tonight
...
#w A: 新しい家はどうですか B: とてもべんりです。駅に近いですから - how is a new house? B: Its convinient, because is close to the station 2style

#w A: このレストランにたくさんの人がいますね B: ここは有名ですからね (ゆうめい) - Is a lot of people in this restaurant. isn't is? B: Because here is a very famous nee

## Particles

### よ 

- letting the listener know the information
- emphasizing information
- information not known to the listener

#w この店はとても有名ですよ（みせ、ゆうめい） - this restaurant is very famous, you know
#w わたしの家から駅までは遠いですよ（いえ、えき、とお） - my house is far from the station, you know
#w これはあなたのかさですよ - this is your umbrella, you know

Difference between よ and ね
#w 今日はあついですね - today is hot, isn't it?
#w 明日はあついですよ - tomorrow will be hot, you know
...
<!--ID: 1763465822923-->
 ...
 one (used when counting things)   #card
ほんやく: ひとつ 
<!--ID: 1763465822924-->


 two (used when counting things)   #card
ほんやく: ふたつ 
<!--ID: 1763465822925-->
...
<!--ID: 1763465822943-->
 ...
 soba (Japanese buckwheat noodles)   #card
ほんやく: そば 
<!--ID: 1763465822944-->


 udon (Japanese thick white noodles)   #card
ほんやく: うどん 
<!--ID: 1763465822945-->
...
<!--ID: 1763465822985-->
 ...
 welcome (in shops, in home)   #card
ほんやく: いらっしゃいませ  
<!--ID: 1763465822986-->


 this way/over there please #card
ほんやく: こちら/あちら へどうぞ 
<!--ID: 1763465822987-->
...
<!--ID: 1763465823071-->
 ...
 there is a lot of oranges and pears #card
ほんやく: みかん と かしが たくさんあります 
<!--ID: 1763465823072-->
...
<!--ID: 1763465823083-->
 ...
 we will pay together #card
ほんやく: いっしょ**で**おねがいします (べつべつ) 
<!--ID: 1763465823084-->
...
<!--ID: 1763465823089-->
 ...
 is not lively (more polite) #card
ほんやく: にぎやかではありません 
<!--ID: 1763465823090-->


 is not lively (less polite) #card
ほんやく: にぎやかじゃありません 
<!--ID: 1763465823091-->
...
<!--ID: 1763465823092-->
 ...
 wasn't clean (more polite)  #card
ほんやく: きれいではありませんでした 
<!--ID: 1763465823093-->


 wasn't clean (less polite) #card
ほんやく: きれいじゃありませんでした 
<!--ID: 1763465823094-->
...
<!--ID: 1763465823102-->
 ...
 that hotel wasn't very clean   #card
ほんやく: あのホテルはあまりきれいではありませんでした  
<!--ID: 1763465823103-->
...
<!--ID: 1763465823115-->
 ...
 this is your umbrella, you know #card
ほんやく: これはあなたのかさですよ 
<!--ID: 1763465823116-->
