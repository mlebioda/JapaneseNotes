...
**(か)**
#w 火曜日（かようび）- tuesdat #k
#w 火山（かざん) - volcano #k

---

#w 火が燃えている（ひがもえている） - the fire is burning #k
#wc 燃える（も）- płonąć samo
#wc 燃やす（も）- spalać coś (ktos)

#w ゴミを燃やす(も）。→ Spalam śmieci. 

#w 火が消えた（ひがきえた）- ogien zgasl #k

#wc 消える（きえる）- zganac, zniknąć, wyłączyć się (Sam)

#w 火が消えた（ひ、き）。- Ogień zgasł. #k
#w 電気が消えた (でんき、き)。- Światło zgasło. #k
#w 雪が消えた（ゆき、き） - Śnieg stopniał (dosł. zniknął). #k
...
**(う)**  
#wc 生まれる（う）- to born #k
#w 子犬が生まれる（こいぬ,う）- puppy was born
...
#w 漢字を学ぶ（かんじ、まな）- to learn kanji #k

#w 学校で日本語を学ぶ（がっこう、まな) - to learn japanese in shool (academic style)


**(がく)**  
#w 留学（りゅうがく）- studying abroad #k
...
#w 友人（ゆうじん）- przyjaciel, formalny styl #k 
#w 親友（しんゆう）- #k best firend
