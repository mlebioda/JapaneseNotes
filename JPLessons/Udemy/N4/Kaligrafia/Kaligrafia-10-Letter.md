...
#w 兄から手紙が来ました（てがみ、き）- A letter came from my elder brother
#w この紙を切ってください（かみ、き）- Please cut this paper
#w 昨日、母に手紙を出しました（てがみ、だ）- I sent a letter to my mother yesterday?

#wc 出す（だす）- nadać, wysłać, ale w konteście fizycznym, list, dokument
...
7 + knife
**(き)**
#w 紙を切る（かみ、き）- to cut paper 
#wc 切る（きる）- to cut
#w 切手（きって) - stamp

#w 姉は切手を買いに行きましたよ（あえ、きって、か）- My elder sister went to buy a stamp
#w ８４円の切手をください（きって）- Please give me a stamp of 84 yen
...
**(つか)**
#wc 使う（つか）- to use
#w 使い（つか）- errand (act of use, casual)
#w この切手を使ってください（きって、つか）- Please use this stamp
#w 料理にはこの魚を使います（りょうり、さかな、つか）- I'll use this fish for cooking
#w この紙を使って、メモを作ります（かみ、つか、つく）- I;; will make notepad using this paper

#w メモ - notepad

**(し)**
#w 使用（しよう）- use /użycie/usage/technical
#w この店でクレジットカードが使用できます（しよう）- You can use credit card at this store
...
**(うつ)**
#wc 写る（うつ）- be projected
#wc 写す（うつ）- to copy/to photograph (more formal than take photo)
...
**(しゃ)**
#w 写真（しゃしん）- photo/picture
#w 映写（えいしゃ）- projection
...
**(ま)**
#w 真面目（まじめ）- serious
#w 真心（まごころ）- sincerity (szczerość)

#w 山田さんは真面目な人です（まじめ、ひと) - Mr yamada is a serious person

**(まこと)**
#w 真（まこと）- true 
#w 真の話（まこと,はなし）- true story
...
**(おく)**
#wc 送る（おく）- to send
#w 手紙を送る（てがみ、おく）- send a letter
#w スミスさんに手紙を送ります（てがみ、おく）- I will send a letter to MR smith
...
**(そう)**
#w 送金（そうきん）- remittance (sending money,przekaz)
#w 送料（そうりょう）- postage (opłata pocztowa)
...
**(みやこ)** 
#w 京都（みやこ）- old name of kyoto - not used currenyly much

**(きょう)**
#w 東京（とうきょう）- tokyo
#w 上京（じょうきょう）- go/come to tokyo

#w 兄は明日上京します (あに、あした、じょうきょう) - My elder brother will go to Tokio tommorow

#w 姉は今月上京します（あね、じょうきょう) - Elder sister will go to tokio this month
...
**(はな)**
花（はな）- flower
#w きれいな花（はな）- beutiful flower
#w 花見（はなみ）- hanami

#w この花の写真はあなたが写しましたか（はな、しゃしん、うつ）- It that you who PHOTOGRAPHED this picture of the flower?
...
#w 赤色（あかいろ）- red color (whole)
#w 色（いろ）- color

#w この写真の色はいいですね - colors of this photo is good
#w どんな色のセーターを買いますか（いろ、か）- What color sweater are going to buy?

**(しょく)**
#w 着色（ちゃくしょく）- coloring (ubierać w kolor)
...
#w あの赤い花はきれいですね（あか、はな）- This red flower is beautiful, isn't it?

**(せき)**
#w 赤十字（せきじゅうじ）- red cross
#w 赤道（せきどう）- equator/równik

#w 私は赤十字の会員です（せきじゅうじ、かいいん）- I'm a member of the red cross
#w 会員（かいいん）- member
...
#w この青い服を買います（あおい、ふく、か）- I'll buy this blue outfit

**(せい)**
#w 青年（せいねん）- young boy/man
#w 青春（せいしゅん）- youth

#w あの青年は先生の弟です（せいねん、おとうと）- That young man is the teacher's younger brother
