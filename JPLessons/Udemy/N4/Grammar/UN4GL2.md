TARGET DECK: N4-Udemy::N4-Udemy-Grammar::UN4GL2-Could-you-tell-me-where-to-place-trash-please

# ごい
#w ゴミを置く場所を教えてください（お、ばしょ、おし) - Could you tell me where to throw away the trash please?

#w 商品 (しょうひん) - product


#wc (を) 片付ける (かたづ) - to put in order / tidy something up
#w 部屋を片付けました（へや、かたず）- I cleaned a room

#wc (が) 片付く (かたづ) - to be put in order
#w 部屋が片付いていた（へや、かたづ）- room was in good order(schluddny)


#w ごみ - trash

#wc (が)燃える (も) - to burn
#w 紙が燃える（かみ、も）- to burn trash
#w 木が燃えている（き、も）- tree is burning


#w 燃えるごみ (も) - burnable trash
#w 燃えないごみ (も) - non-burnable trash
#w 生ごみ (なま) - kitchen waste
#w 粗大ごみ (そだい) - bulky trash
#w 紙 (かみ) - paper
#w 缶 (かん) - can


#wc 捨てる (す) - to throw away


#w 手袋（てぶくろ）- glove
#w 袋 (ふくろ) - bag / sack
#w ごみ袋 (ぶくろ) - garbage bag
#w 緑 (みどり) - green
#w オレンジ - orange
#w ピンク - pink

#wc Place + に Nを 　入れる (い) - to put into　（structure)
#w ゴミを入れる（い）- to put the trash in
#w ゴミ袋にゴミを入れる（ぶくろ、い） - to put trash into the trash bag
#w カバンに本を入れました（ほん、い）- I put books into my bag


#wc 申し込む (もう・こ) - to propose / to apply for
#w けっこんを 申し込む（もうしこむ）- to propose marriage
#w 試合を申し込む（しあい、もうしこむ）- (propose) tp challenge somebody to a game

#w 有名な大学に申し込む（ゆうめい、だいがく、もうしこむ）- to apply to a famous university
#w 仕事を申し込む（しごと、もうしこむ） - to apply for a job


#w 出し方 (だ・かた) - the way to put out trash
#w 場所 (ばしょ) - place

#w 置き場 (お・ば) - a place for something
#w ゴミ置き場（お、ば） - garbage disposal
#w 自転車置き場（じてんしゃ、おきば） - bicycle parking area

#w 横 (よこ) - side
#w 近所 (きんじょ) - neighborhood


#w など - and so on / etc.
#w  私は日本、中国、アメリカ**など**に行ったことがあります - I have been to Japan, china, usa and so on

#w ビンや缶などは燃えないごみです（かん、も）- The bottels, cans etc. are non-burnable garbage

---
#wc (と/が)違う (ちが) - to be different from / to be wrong
#w 私は弟**と違って**、朝早く起きます（おとうと、ちが、あさ、はや、お）- I'm different from my younger brother, I get up early in the morning

#w 色が違います（いろ、ちが) - colors are different

#w 答えが違っています（こた、ちが) - The answer is wrong

---

#w 駐車場 (ちゅうしゃじょう) - parking lot
#w 駐車 (ちゅうしゃ) - parking / to park
#w 箱 (はこ) - box
#w ごみ箱 (ばこ) - trash can
#w 文化 (ぶんか) - culture

#w 歌舞伎 (かぶき) - Kabuki (Japanese classical drama)
#w 能 (のう) - Noh (Japanese classical drama)


#wc 運ぶ (はこ) - to carry
#w 遅刻 (ちこく) - tardiness / to be late (for something sheduled)

---

#wc (へ・に)引っ越す (ひ・こ) - to move (to a new location)
#w 新しい家に引っ越す（あたら、いえ、ひっこ）- move to a new home

#w 引っ越し (ひ・こ) - moving (to a new location)
#w 引っ越しをする（ひっこ) - to move to a new location (made from verb)


---

#w 花見 (はなみ) - cherry blossom viewing
#w 花見をする（はなみ）- to do cherry blossom viewing
#w 一緒に花見に行きませんか（いっしょ、はなみ）- would you like to go to cherry blossom viewing with me?

---

#w 上野公園 (うえの・こうえん) - Ueno Park
#w 携帯電話 (けいたい・でんわ) - mobile phone
#w 冷蔵庫 (れいぞうこ) - refrigerator


#w サイン(する) - sign / to sign
#w ここにサインしてください - please sign here
#w サインしました - i signed my name


#wc (A+は+B+に+N+を)くれる - to give something or does something for the speaker
#w おもちゃ - toy
#wc 手伝う (てつだ) - to help
#w 運転 (うんてん) - driving / to drive
#w 運転手 (うんてんしゅ) - driver

# ひょうげん

#w (すみません)ちょっといいですか - Do you have a moment?
#w そうなんですね - i see
#w それから - after that, and also
#w 手を洗って、それから、ご飯を食べます（て、あら、ごはん、た） - I will wash my hands, **and then** eat the meal
#w お茶、それから、お菓子を買ってください（ちゃ、かし、か）- Please buy tea, **and also** some sweets

# 文法

## とか...とか - enumerate examples of things, behaviors or actions

Structure:
- とか...とか - and....and.... etc.
	- usualy more than once
- Examples
	- 昨日、日本料理を食べに行きました。すし**とか**、そば**とか**を食べました - Yesterday i was n japanese restaurant. I ate sushi, Soba and so on

#w 昨日、日本料理を食べに行きました。すし**とか**、そば**とか**を食べました - Yesterday i was n japanese restaurant. I ate sushi, Soba and so on

#w A: 粗大ゴミは何ですか（そだい) B: 椅子とか、自転車とか、テレビとかは粗大ゴミです（いす、じてんしゃ、そだい) - A: What is bulky trash? B: Chairs, bicycles, TVs and so on

#w A: 日本の文化は少し分かりますか。B:はい、歌舞伎とか、脳とかを見たことがあります（ぶんか、かぶき、のう) - Do you know a little about Japanese culture? B: Yes, I have watched Kabuki and Noh etc....

---

## 。。。ので - because
- 。。。ので - because
	- more soft in formal situations
	- more objective than kara
...
#w 風邪を引いたので昨日学校を休みました（かぜ、ひ) - Because I caught a cold, I was absent from school yesterday

#w 今朝電車が遅れたので、学校に遅刻しました。(けさ・でんしゃ・おく・がっこう・ちこく) - Because the train was late this morning, I was late to school.

#w 明日仕事が早いので、今晩早く寝るね。(あした・しごと・はや・こんばん・はや・ね) - Because I will work early tomorrow, I will sleep early tonight.

#w ここは静かなので、引越ししたいと思います。(しず・ひっ・こ・おも) - Because it is quiet here, I think I want to move here.

#w もう夏なので、海に行きましょう。(なつ・うみ・い) - Because it's summer, let's go to the beach.

---
## Nなら - as for,  jesli o tym mowa

- Used when the speaker asks a question and the listener gives their idea or opinion on the topic

Structure:
- Nなら - as for,  jesli (o tym mowa)


#w A：花見に行きたいんですが、どこがいいですか。(はなみ・い)　B: 花見**なら**、上野公園がいいと思います。(はなみ・うえの・こうえん・おも) - A: I want to go cherry-blossom viewing, where would be good? (introducing topic) B: As for cherry blossom viewing, I think Ueno Park is good. (jesli mowa o..)

#w A: どんな スポーツができますか B: 野球はできないですが、サッカならできます (やきゅう) - What kind of sports can you do? I can't play baseball, but as for soccer i can play

---

## は - emphasizes a noun placed right before the other particle
...
#w 病院では、携帯電話をかけてはいけません（びょういん、けいたいでんわ）- It is forbidden to use the cellphone in the hospital (emphasize hospital)


#w みんなには言わないでください。(い) - Don't tell the other people. (emphasize others/everyone)

#w 明日からは休みです。(あした・やす) - Starting tomorrow is a holiday.(emphasize form tommorow)

#w この部屋ではタバコを吸ってはいけません。(へや・す) - It is forbidden to smoke in this room. (emphasize this room)

---

## Vて いただけませんか - polite requests. Politer than てください

- いただく - もらう - keigo
- いただく -> いただける 
- Politer than てください
- used to people superior to you
Structure: 
- Vて いただけませんか - polite requests


#w 社長、サインをしていただけませんか。(しゃちょう) - President, could you please sign?
#w 高橋先生、この漢字の読み方を教えていただけませんか。(たかはし・せんせい・かんじ・よ・かた・おし) - Mr. Takahashi, could you teach me how to read this kanji?
#w 机の上を片付けていただけませんか。(つくえ/うえ/かたづ) - Would you clean your desk?

## Vて形 + あげます・くれます・もらいます

### Aは + Bに + Vて形 + あげます - I do something for someone

Structure:
- Aは + Bに + Vて形 + あげます - A does V for B
	- A - giver
		- You, some one close to you
		- If giver is clear, can be ommited
	- B - receiver
	- **Don't use to superior**
Examples:
#w 私は弟におもちゃを買ってあげました（おとうと、か) - I bought toy for my younger brother

#w 宿題を手伝ってあげます。(しゅくだい・てつだ) - I will help you with the homework.

#w 妹に弁当を作ってあげます。(いもうと・べんとう・つく) - I will make a boxed lunch for my younger sister.

#w 山田さんに中国語の本を貸してあげます。(やまだ・ちゅうごくご・ほん・か) - I will lend Mr. Yamada a Chinese language book.

### Vて形 + くれます - Someone does something to me

Structure:
- Aは + Bに + Vて形 + くれます - A does V for B
	- A - giver
	- B - receiver
		- You or someone close to you
		- often ommited
Examples:
#w ラジさんは私の引っ越しに手伝ってくれます（ひっこ、てつだ）- Raj will help me with the moving

#w 安藤さんは日本語を教えてくれました。(あんどう・にほんご・おし) - Miss Ando taught me Japanese.

#w 母は私の部屋のごみを捨ててくれました。(はは・わたし・へや・す) - My mom threw out the trash in my room for me.

#w 手伝ってくれて、ありがとうございました。(てつだ) - Thank you for helping me.

### Vて形 + もらいます - somebody helped you with something that you asked to do

Structure:
- Bは + Aに + Vて形 + もらいます - A does V for B
	- A - giver
	- B - receiver - usually speaker
Examples:
#w 私はあんどうさん**に**本を貸してもらいました（か）- Miss ando lent me a book (i asked her for it)

#w このかばんは重すぎるので、運ぶ時、ラジさん**に**手伝ってもらいました。(おも・はこ・とき・てつだ) - Because the bag was too heavy, Raj helped me carry it. (i asked for it)

#w 次の電車がいつ来るかを知りたかったので、駅員**に**教えてもらいました。(つぎ・でんしゃ・く・し・えきいん・おし) - Because I wanted to know when the next train was, the station staff told me. (i asked for it)

#w いつも母に晩ご飯を作ってもらいます。(はは・ばん・はん・つく) - My mom always cooks dinner for me. (i asked for it)

## Vて形 + あります - explain conditions/situations of an object - current on continuous states

Structure
- Vて形 + あります - explain conditions/situations of an object
	- only for object
	- current or continuous state, wynik swiadomego czyjegos dzialania
	- focus on effect, not person

Examples:


#w 机の上に本が置いてあります。(つくえ・うえ・ほん・お) - There is a book **left** on the desk. (someone put it)

#w 燃えるごみはもう出してあります。(も・だ) - The burnable waste has already **been taken** out. (by someone)

#w 旅行を申し込んであります。(りょこう・もう・こ) - I have already **applied** for traveling.


---
# Vocabulary

## くれる - someone gives something or does something for the speaker
Structure:
- A+は+B+に+N+を+**くれる**
	- A - giver
	- B - Receiver (I'm or some close to speaker) when speaker is im, watashi is omitted
- Example
	- 山田さんは私の妹にプレゼントをくれました（いもうと）- Yamada gave a present to my younger sister
- Difference with あげる
	- あげる - subject speaker or someone close, receiver someone else
		- 私の兄は友達に花をあげました（あに、はな) - My elder brother  gave his friend flowers
	- くれる - subject is anyone, receiver speaker or someone close
		- 友達は私に花をくれました - My friend gave me a flower


#w 山田さんは私の妹にプレゼントをくれました（いもうと）- Yamada gave a present to my younger sister
#w 友達は映画のチケットをくれました（ともだち、えいが）- Friend gave me ticket for a movie

#w 友達は私に花をくれました - My friend gave me a flower
#w 私の兄は友達に花をあげました（あに、はな) - My elder brother  gave his friend flowers
...
please sign here #card
ここにサインしてください
<!--ID: 1777104965371-->



I signed my name #card
サインしました
<!--ID: 1777104965372-->
