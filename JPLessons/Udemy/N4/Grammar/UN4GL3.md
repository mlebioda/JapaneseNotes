TARGET DECK: N4-Udemy::N4-Udemy-Grammar::UN4GL3-its-too-heavy-so-i-cant-carry-it

# ごい
#w 重すぎて運べないですよ（おも、はこ）- It's too heavy so I can't carry it.


#w 動詞の可能形が作れること (どうし・かのうけい・つく) - Being able to make the potential form of verbs.

#w 可能形（かのうけい）- potential form 

#w 可能形動詞（かのうどうし）- potential verbs

#w 可能動詞の使い方をマスターすること (かのうどうし・つか・かた) - Master how to use potential verbs.  

---


#w お願い (ねが) - request / wish / please
#w 一つお願いがあるんです（おねが）- I have one wish
#w 5000円を貸してくれる。お願い！（か、おねが）- Could you lend me 5000yen? Please! 


#w ガラス - glass
#w 新聞紙 (しんぶんし) - newspaper (paper)
#wc 包む (つつ) - to wrap / to pack

#wc (が)割れる (わ) - to be broken / to crack (by itself) + particle
#w ガラスが割れる（わ) - glass is broken (not because one's intention)
#w お皿が割れる（さら、わ）- A plate is broken (not because one's intention)


#w 半分 (はんぶん) - half
#w 一日の半分（いちにち、はんぶん）- half a day
#w 半分の量（はんぶん、りょう）- half amount
#w 量 (りょう) - amount
#w パンフレット - pamphlet / brochure

---

#w 案内 (する)(あんない) - guide / to guide / to introduce
#w 案内人（あんないにん) - the guide (person)
#w 新しいビルの案内（あたら、あんない) - a guide to a new building

#w 会社案内（かいしゃ、あんない）- company information
#w 学校案内（がっこう、あんない）- school information

#w あの人は私を席に案内してくれました（せき、あんない）- That person guided me to my seat

---

#w 棚 (たな) - shelf
#w 書類 (しょるい) - documents / files


#w このまま - to leave something as it is (current situation that will continue on)
#w そのまま - to leave something alone there (situation that will continue on in exactly the same way)

#w このままでいいですよ - It's all right to keep doing this
#w そのままで待ってください(ま) - Please hold on
#w そのままにしておく- leave something as it is (put) 

---


#w コピー - copy / to copy
#w コピー機 (き) - copy machine
#w ルール - rule

#w 彼 (かれ) - he / boyfriend
#w 彼女 (かのじょ) - she / girlfriend
#w 恋人 (こいびと) - lover

#w 予報(する) (よほう) - forecast / to forecast
#w 天気予報 (てんきよほう) - weather forecast


#w 予習 (よしゅう) - preparation for a lesson / to prepare for a lesson
#w 復習 (ふくしゅう) - review / to review
#w 予約 (よやく) - reservation / to reserve

---

#w 人気 (にんき) - popularity / popular (have a good reputation and be accepted by society)
#w 人気がある (にんき) - to be popular
#w 人気がない (にんき) - to be unpopular

#w 人気の名前（にんき、なまえ）- popular name
#w 人気のレストラン（にんき) - popular restaurant

---

#wc (に)間に合う (ま・あ) - to be in time (for) + particle
#w バスに間に合う（ま、あ）- to catvh bus (be on time)
#w 電車に間に合う（でんしゃ,ま、あ）- to catvh train (be on time)

---

#w 博物館 (はくぶつかん) - museum
#w 電気 (でんき) - electricity
#w ビザ - visa
#w パスポート - passport
#w 海外 (かいがい) - overseas
...
#w いっぱい - much / full / often / a great deal = たくさん
#w 本がいっぱいあります - there are a lot of books (more emotional)
#w いっぱい食べてください - please eat a lot (more emotional))
#w お腹がいっぱい（おなか) - i'm full
#w 元気いっぱい - very energetic

---

#wp 結構 (けっこう) - nice / great / no need / very = とても
#w 結構な天気（けっこう、てんき) - good weather
#w 結構なプレゼント（けっこう) - good present

#w A: コーヒーをもう一杯いかがですか, B: けっこうです（いっぱい) - Would you like another cup of coffe? B: No (no need)

#w 結構綺麗（けっこうきれい) - very beautifull
#w 結構飲む (けっこうのむ) - drink a lot
...
#w(を) 怪我(する) (けが) - injury / to get injured + particle

#w 足を怪我する（あし、けが) - get foot injury
#w 手を怪我する（て、けが）- to get a hand injury
...
#w 音 (おと) - sound
#w 車の音（くるま、おと）- sound of a car
#w 雨の音（あめ、おと）- sound of a car

#w 声 (こえ) - voice
#w 人の声 (ひと、こえ) - voice of person
#w 鳥の声 (とり、こえ) - voice of bird
...
#wc (が)見える (み) - to be in sight / can see + particle


#wc (が)聞こえる (き) - to reach one's ears / can hear + particle


#w 申込書 (もうしこみしょ) - application
#w スマートフォン - smartphone

#w エアコン - air conditioner
#w エアコンをつける - to turn on air conditioner
#w エアコンを消す（け） - to turn off air conditioner
...
#w 展覧会 (てんらんかい) - exhibition
#w 美術館 (びじゅつかん) - art museum
#wc 壊れる (こわ) - to be broken



# ひょうげん

#w そうね ( plain form soudesune) - yes, used when you want to show you agree with what the other person says (often women use)

#w 雨が降りそうですね（あめ、ふ）B: そうね - A: It's looks like it's going to rain B: Yeah (women use)

# 文法

## 可能形（かのう) - potential form - can

Structure
 - が + V 可能形
	 - 私は日本語の新聞を読みます - i read japanese newspapers
	 - 私は日本語の新聞**が**読**めます** - i can read japanese newspapers
...
#w 私は日本語の新聞**が**読**めます** - i can read japanese newspapers 

#w 明日は 休みなので、家で そうじができる - Because tomorrow is day of, I can clean my house

#w 図書館で外国語の辞書が借りられる（としょかん、がいこくご、じしょ、か) - I can borrow a foreign language dictionary from library

#w A: どうして、元気ないの B: 昨日あまり眠れなかった（ねむ) - A: Why do you look so down? (not fine) B:
...
Structure:
- Condition (Vdict) + と + Result - if Condition then result
	- 風邪を引くと、何もやりたくない。(かぜ・ひ・なに) - If I catch a cold, I don't want to do anything.


#w 風邪を引くと、何もやりたくない。(かぜ・ひ・なに) - If I catch a cold, I don't want to do anything.
#w 全部の本を入れると、箱は重すぎると思います。(ぜんぶ・ほん・い・はこ・おも・おも) - I think the box will be too heavy if I put all the books in it.
#w この申込書がないと、申し込むことができません。(もうしこみしょ・もう・こ) - If you don't have this application form, you cannot apply for it.
...
## ....します - situation is changed through a person's will - なる but because of person, not nature

- ...なります - change state because of nature
	- 最近、あたたかくなりました(さいきん) - it became warm recently
- ...します - change caused by person
	- エアコンをつけて、部屋を暖かくしましょう - Turn on the air conditioner to make room warm (become warm by human will)
Structure:
- い-adj -> く
	- あたたかい→あたたかく
- な-adj＋にします
	- 部屋をきれいにしました。(へや) - I cleaned my room.
- N＋にします
- N+ を。。。します　- when mention an subject to change
	- .


#w 最近、あたたか**くなりました**(さいきん) - it became warm recently
#w 最近(さいきん) - recently
#w エアコンをつけて、部屋を暖か**くしましょう** - Turn on the air conditioner to make room warm (become warm by human will)

#w ラジオの音を大きくしてください。(おと・おお) - Please turn up the radio volume.
#w 部屋をきれい**にしました**。(へや) - I cleaned my room.
#w パンフレットを半分だけ**にして**、あとは箱に何か軽いものを入れてください。(はんぶん・はこ・なに・かる・い) - Zmniejsz (liczbę) broszur do połowy, a do pudełka dołóż coś lekkiego

## N＋に＋します - speaker says what he/she decided on

Structure:
- N＋に＋します

#w A: 彼女へのプレゼント、何**にする**？(かのじょ・なに) B: うーん、花かな。女の子はみんな花が好きでしょう。(はな・おんな・こ・はな・す) - A: What present will you give to your girlfriend? B: Um, maybe flowers. All girls like flowers, right?

#w A: 部長、来週月曜日の会議は何時**にしますか**。(ぶちょう・らいしゅう・げつようび・かいぎ・なんじ) B: 午後3時**にしましょう**。(ごご・じ)  - A: General manager, what time will the meeting be on the next Monday? B: Let's make it at 3:00 p.m

---
## V「て形」＋おきます - V continues without any changes, leave

Structure: 
- V「て形」＋おきます - 
	- V continues without any changes
		- Often with そのまま、このまま
		- おいておく - often pronounced as おいとく
		- しておく - often pronounced as しとく
	- Do V in advance (preparation to achieve goal)


#w そのまま にして **おいて** ください - Pease leave it as it is
#w 窓を開け**ておいて**ください。(まど・あ) - Please leave the window open.
#w 電気はそのままつけ**ておいて**ください。(でんき) - Please leave the light on as it is.

#w A:　この 書類はどこ**におきますか**（しょるい）、B:机の上においといて （おいておいてください）（つくえ、うえ）- A: Where can I put this file? B: Leave it on the desk

#w おいといて （おいておいてください） - leave it leaved please.. (short and long version)

#w 母が戻る前に、部屋を片付け**ておきます**（はは、もど、まえ、かたづ）- I will clean up my room before mum comes back

#w 出かける前に、天気よほうを調べて**おいて**ください。(で・まえ・てんき・しら) - Please look up the weather forecast before leaving.
#w 試験の前によく復習して**おいて**ね。(しけん・まえ・ふくしゅう) - Please review well before the test.
#w あのレストランはとても人気ですから、予約して**おかないと**入れません。(にんき・よやく・はい) と=if - Because that restaurant is very popular, if we don't make reservation in advance, we can't enter.


## V「て形」はいけません - is forbidden to do something

Structure:
- V「て形」はいけません - is forbidden to do something
	- 店の入り口の前に駐車してはいけません。(みせ・い・ぐち・まえ・ちゅうしゃ) - It is forbidden to park in front of the store.


#w 店の入り口の前に駐車し**てはいけません**。(みせ・い・ぐち・まえ・ちゅうしゃ) - It is forbidden to park in front of entrance of the store.
#w あなたはお酒を飲んだから、運転し**てはいけない**よ。(さけ・の・うんてん) - You mustn't drive, because you drank alcohol.
#w この博物館では、写真を撮っ**てはいけません**。(はくぶつかん・しゃしん・と) - It is forbidden to take pictures in this museum.

---
## V「なくて」はいけません - must to do something

Comparsion
- Vなければなりません
	- more formal
	- if i don't fo something... something not happen
	- sounds like rule
- Vなくてはいけません - because 
	- more casual

Structure:
- V「なくて」はいけません/いけない - must to do something
	- 海外に行く時は、パスポートを持たなくてはいけません。(かいがい・い・とき・も) - You must take your passport when you go abroad.
- Casual way:
	- V＋なくちゃい(けない )
		- 会議が始まると休めないから、今からランチを食べなくちゃ(いけない) - If meetign begins, I don't have time, so I have to eat lunch not (casual have to)


#w 海外に行く時は、パスポートを持たな**くてはいけません**。(かいがい・い・とき・も) - You must take your passport when you go abroad. (less formal have to)
#w このDVDは金曜日までに返さ**なくてはいけません**。(きんようび・かえ) - I have to return this DVD by Friday.(less formal have to)
#w 日本語会話の練習なので、みなさんは日本語で話さな**くてはいけないよ**。(にほんごかいわ・れんしゅう・にほんご・はな) - It is a Japanese conversation exercise, so everyone must speak Japanese.(less formal have to)

---
## ように - act on purpose or goal in mind, in order to, so that

Structure:
- V「stem」ように
- V「nai」ように
	- Before ように - goal
	- Often used with potential form 

#w 電車に間に合う**ように**、駅まで走って行きます(でんしゃ、ま、あ、えき、はし) - In order to cat the train, I will run to the station
#w ガラスが割れないように、新聞紙で包みます（わ、しんぶんし、つつ) - I will pack the glass with newspaper (in order to) so that it won't break

#w 遅刻しない**ように**、一つ前の電車に乗りました。(ちこく・ひと・まえ・でんしゃ・の) - In order not to be late, I took the earlier train.
#w 日本語が上手に**なれ**る**ように**、毎日勉強しています。(にほんご・じょうず・まいにち・べんきょう) - I study Japanese every day **so that** I can become good at Japanese.
#w 試合に**勝て**る**ように**、みんな毎日練習を頑張っています。(しあい・か・まいにち・れんしゅう・がんば) - In order to win the game, everyone tries their best to practice every day.


#TODO when potential form
...
- 見える - Something naturally comes into sight  naturally reaches one's eyes
- 見られる - can see (potential for from see)
	- Person intends to see something and being able to see it
		- あそこの映画館で、昔の 映画が見られます（えいがかん、むかし、えいが、み）- You can see old movies in the movie teather

#w 富士山が見える - Mt. Fuji is visible

#w あそこの映画館で、昔の 映画が見られます（えいがかん、むかし、えいが、み）- You can see old movies in the movie teather

#w 三番出口を出て、白い建物が見えます（三番でぐち、で、たてもの、み) - After you come out from exit no 3, you can see white building
## が + 聞こえる - is heard

Structure:
- が + 聞こえる 
	- 赤ちゃんの声が聞こえます
- 聞こえる - Something naturally comes into sound naturally reaches one's ears
- 聞ける - can hear (potential for from hear)
	- Person intends to hear something and being able to hear it
		- スマートフォンで音楽が聴けます - I can listen to music on my smartphone

#w 赤ちゃんの声が聞こえます - i baby's voice is heard

#w スマートフォンで音楽が聴けます - I can listen to music on my smarthphone

#w となりの部屋から音楽が聞こえます（へや、おんがく、き) - I can hear music from the next room
# Summary
...
nice / great / no need / very = とても #card
ほんやく: 結構（けっこう）
過去形: —
否定形: —
副詞形: —
...
to leave something as it is (current situation that will continue on) #card
このまま
<!--ID: 1778257577036-->
...
to leave something alone there (situation that will continue on in exactly the same way) #card
そのまま
<!--ID: 1778257577037-->
...
It's all right to keep doing this #card
このままでいいですよ
<!--ID: 1778257577038-->
...
leave something as it is (put) #card
そのままにしておく
<!--ID: 1778257577040-->
...
much / full / often / a great deal = たくさん #card
いっぱい
<!--ID: 1778257577064-->
...
to turn on air conditioner #card
エアコンをつける
<!--ID: 1778257577089-->
...
yes, used when you want to show you agree with what the other person says (often women use) #card
そうね (plain form soudesune)
<!--ID: 1778257577095-->
...
leave it leaved please.. (short and long version) #card
おいといて（おいておいてください）
<!--ID: 1778257577117-->
