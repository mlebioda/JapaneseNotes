...
#w 受身形(うけみけい)の関連文法(かんれんぶんぽう)を把握(はあく)する - learn how to use grammar related to passive form
...
#w 生産(せいさん)(する) - production / to produce + verb

#w 輸出(ゆしゅつ)(する) - export / to export + verb
#w 輸出品(ゆしゅつひん)(する) - exported products
#w 自動車（じどうしゃ）を輸出（ゆしゅつ）する - to export rice

#w 輸入(ゆにゅう)(する) - import / to import + verb
#w 輸入品(ゆにゅうひん)(する) - imported products
#w タイの米（こめ）を輸入（ゆにゅう）する - to import Thailand rice

---

#w 実(じつ)は - actually / in fact
#w 実(じつ)は 日本に始（はじ）めて来（k）たんです - Actually, I came to Japan for the first time (providing information)

#w 本日(ほんじつ) - today (formal or writting)
#w 本日(ほんじつ)はよろしくお願（ねが）いします - pleased to meet you today (formal) 

#w 向こう(むこう) - other side
#wc 頼む(たの) - to ask / to request
#wc 急ぐ(いそ) - to hurry

---

#wp 急(きゅう) - hurry / sudden
#wp 急(きゅう)に - suddenly
#w A：明日（あした）から フランスに出張（しゅっちょう）に行きます（い）B:え、急（きゅう）だなあ - A: I'm going to France for a business trip tomorrow B: Oh, it's so sudden
#w 車（くるま）が急（きゅう）に止（と）まった - Car suddently stopped

---

#w 関係(かんけい)(する) - relationship between something / to be related to + verb
#w 関係（かんけい）がある - to have a connection
#w 関係（かんけい）がない - to have no connection
#w 恋人関係（こいびとかんけい）- a romantic relationship
#w 仕事関係（仕事かんけい） - a work relationship
#w 本社（ほんしゃ）**に**関係（かんけい）する - to be related to the head office
#w 法律（ほうりつ）**に**関係（かんけい）する - to be related with law



---

#w びっくり(する) - surprise / to be surprised + verb
#w 見学(けんがく)(する) - a study visit / field trip / observational visit

#wc 連れる(つ) - to take somebody along with
#wc 盗む(ぬす) - to steal
#wc 噛む(か) - to bite
#w 紹介(しょうかい)(する) - introduction / to introduce + verb
#wc 叱る(しか) - to scold (besztac)
#wc 助ける(たす) - to help
#wc 踏む(ふ) - to step

---

#wc 開く(ひら) - to open (often to object to spread to open: doors, book, flower) (transitive)

#w 窓（まど）を開く（ひら） - to open window
#w 店（みせ）を開く（ひら） - to open shop / to start business
#w 展覧会（てんらんかい）を開く（ひら） - to hold/host an exebition (open)

---

#w 修理(しゅうり)(する) - repair / to repair + verb
#w 時代(じだい) - era / period
#w 江戸時代(えどじだい) - the Edo era
...
#w ワイン - wine
#w 葡萄(ぶどう) - grapes
#w 例え(たとえ) - even if / example
#w 例えば(たとえば) - for example
#w 泥棒(どろぼう) - thief

#w 気持ち(きもち) - feeling
#w 気持ち(きもち) がいい - to be comfortable
#w 気持ち(きもち) が悪い（わる） - to be unpleasant
#w 気持ち(きもち) が変わる（か） - to change my mind




#wc 変わる(か) - to change (intransitive)
#wc 変える(か) - to change (transitive)

#w 調子(ちょうし) - condition
#w 機械(きかい) - machine
#w 機会(きかい) - opportunity
#w 仲間(なかま) - companion
#w 始め(はじめ) - beginning
#w 電報(でんぽう) - telegram
#w 発明(はつめい)(する) - invention / to invent + verb
#wc 苛める(いじ) - to bully
#w 日本酒(にほんしゅ) - Japanese sake
#wc 拾う(ひろ) - to pick up


#w そろそろ９時（じ）です - soon 9 o'clock
#w そろそろ行（い）くわ - i will leave soon
#w そろそろ - soon


#wc 怒る(おこ) - to get angry

#wc 混む(こ) - to get crowded
#w 設立(せつりつ)(する) - establishment / to establish + verb
#w 相談(そうだん)(する) - consultation / to consult + verb
#wc 建てる(た) - to build
#w 故障(こしょう)(する) - breakdown / to break down (machines) + verb
#w 米(こめ) - rice
#w 川(かわ) - river
#w 自動車(じどうしゃ) - car (technical)


#w 失礼(しつれい)(する) - rudeness / to be excused + verb
#w 失礼(しつれい) します - expression when you enter a room
#w 失礼(しつれい) しました - expression when you wish to apologize
#w 失礼(しつれい) ですが - when with superior you want to start conversation

#wc 考える(かんが) - to think (active mental process, working something out)
...
#w 幸せ(しあわせ) - happiness / happy (overall fulfillment)
#w 本文（ほんぶん）- main clause
#w 付属分（ふぞくぶん） - subordinate clause
# ひょうげん


#w 日本(にほん)へようこそ。 - Welcome to Japan.

#w **どれぐらい** — "how much / how long / how many / to what extent"
...
- う → われる
    - 言う(いう) → 言われる(いわれる) — to say → to be said
- く → かれる
    - 書く(かく) → 書かれる(かかれる) — to write → to be written
- ぐ → がれる
    - 脱ぐ(ぬぐ) → 脱がれる(ぬがれる) — to take off → to be taken off
- す → される
    - 話す(はなす) → 話される(はなされる) — to speak → to be spoken to
- つ → たれる
    - 打つ(うつ) → 打たれる(うたれる) — to hit → to be hit
- ぬ → なれる
    - 死ぬ(しぬ) → 死なれる(しなれる) — to die → (to suffer someone's death)
- ぶ → ばれる
    - 呼ぶ(よぶ) → 呼ばれる(よばれる) — to call → to be called
- む → まれる
    - 飲む(のむ) → 飲まれる(のまれる) — to drink → to be drunk
- る → られる
    - 取る(とる) → 取られる(とられる) — to take → to be taken

**Group 2 (G2) — る verbs** Drop る, add られる
- る → られる
    - 食べる(たべる) → 食べられる(たべられる) — to eat → to be eaten
	- 褒める(ほめる) → 褒められる(ほめられる) — to praise → to be praised
...
## 付属分（ふぞくぶん）の 主語（しゅご）- the subject of a subordinate clause

- 本文（ほんぶん）- main clause
- 付属分（ふぞくぶん） - subordinate clause (often with が)

### Structure
- 付属分 + X + 本文 - where X:
	- ...とき...
		- 体(からだ)の調子(ちょうし)がわるいとき、いつもたくさん寝(ね)ています - When I don't feel well, I sleep a lot
			-  わたし - 本文
			- 体 - 付属分
	- ... てから ...
		- 仕事(しごと)が終(お)わってから、ご飯(はん)を食(た)べます - I am going to eat a meal after I finish work
			-  わたし - 本文
			- 仕事 - 付属分
	- ... まえに ...
	- ... **ても** ...
		- お金がなくても、(わたし) 幸せ（しあわ）です - I'm happy even if I don't have money
			- わたし - 本文
			- お金 - 付属分
	- etc
...
### Examples
#w お金がなくても、幸せ（しあわ）です - I'm happy even if I don't have money


#w 仕事(しごと)が終(お)わってから、ご飯(はん)を食(た)べます - I am going to eat a meal after I finish work
#w 雨(あめ)が降(ふ)ったら、ハイキングに行(い)きません - If it rains, I won't go hiking
#w 体(からだ)の調子(ちょうし)がわるいとき、いつもたくさん寝(ね)ています - When I don't feel well(body condition is bad), I always sleep a lot
...
being able to make the verbs' passive form #k #card
動詞(どうし)の受身形(うけみけい)が作(つく)れること
...
learn how to use grammar related to passive form #k #card
受身形(うけみけい)の関連文法(かんれんぶんぽう)を把握(はあく)する
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_受.html">受</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_身.html">身</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_形.html">形</a>
...
to grasp / to fully understand + verb #card
把握(はあく)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_把.html">把</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_握.html">握</a>
<!--ID: 1781113785034-->
...
to understand through practice #k #card
理解する
...
production / to produce + verb #k #card
生産(せいさん)(する)
...
export / to export + verb #k #card
輸出(ゆしゅつ)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_輸.html">輸</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_出.html">出</a>
<!--ID: 1781113785042-->


exported products #k #card
輸出品(ゆしゅつひん)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_輸.html">輸</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_出.html">出</a>
...
to import Thailand rice #k #card
タイの米（こめ）を輸入（ゆにゅう）する
...
actually / in fact #card
実(じつ)は
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_実.html">実</a>
<!--ID: 1781113785048-->


Actually, I came to Japan for the first time (providing information) #k #card
実(じつ)は 日本に始（はじ）めて来（k）たんです
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_実.html">実</a>
...
today (formal or writting) #k #card
本日(ほんじつ)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_本.html">本</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_日.html">日</a>
<!--ID: 1781113785050-->
...
pleased to meet you today (formal) #k #card
本日(ほんじつ)はよろしくお願（ねが）いします
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_本.html">本</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_日.html">日</a>
...
A: I'm going to France for a business trip tomorrow B: Oh, it's so sudden #k #card
A：明日（あした）から フランスに出張（しゅっちょう）に行きます（い）B:え、急（きゅう）だなあ
...
Car suddently stopped #k #card
車（くるま）が急（きゅう）に止（と）まった
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_車.html">車</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_急.html">急</a>
...
relationship between something / to be related to + verb #card
関係(かんけい)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_関.html">関</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_係.html">係</a>
<!--ID: 1781113785059-->


to have a connection #card
関係（かんけい）がある
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_関.html">関</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_係.html">係</a>
<!--ID: 1781113785060-->
...
a romantic relationship #k #card
恋人関係（こいびとかんけい）
...
to be related to the head office #k #card
本社（ほんしゃ）に関係（かんけい）する
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_本.html">本</a>
...
to be related with law #card
法律（ほうりつ）に関係（かんけい）する
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_法.html">法</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_律.html">律</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_関.html">関</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_係.html">係</a>
<!--ID: 1781113785065-->


surprise / to be surprised + verb #card
びっくり(する)
<!--ID: 1781113785066-->


a study visit / field trip / observational visit #k #card
見学(けんがく)(する)
...
to take somebody along with #card
ほんやく: 連れる(つ)
ます形: 連れます
て形: 連れて
た形: 連れた
...
出す形 (start): 盗み出す
尊敬語 (honorific): 盗まれる
お〜になる (honorific): お盗みになる
そう (looks like): 盗みそう
おう (let's): 盗もう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_盗.html">盗</a>
<!--ID: 1781113785069-->
...
出す形 (start): 噛み出す
尊敬語 (honorific): 噛まれる
お〜になる (honorific): お噛みになる
そう (looks like): 噛みそう
おう (let's): 噛もう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_噛.html">噛</a>
<!--ID: 1781113785070-->


introduction / to introduce + verb #card
紹介(しょうかい)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_紹.html">紹</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_介.html">介</a>
<!--ID: 1781113785071-->


to scold (besztac) #card
ほんやく: 叱る(しか)
ます形: 叱ります
て形: 叱って
た形: 叱った
...
出す形 (start): 叱り出す
尊敬語 (honorific): 叱られる
お〜になる (honorific): お叱りになる
そう (looks like): 叱りそう
おう (let's): 叱ろう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_叱.html">叱</a>
<!--ID: 1781113785072-->
...
出す形 (start): 踏み出す
尊敬語 (honorific): 踏まれる
お〜になる (honorific): お踏みになる
そう (looks like): 踏みそう
おう (let's): 踏もう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_踏.html">踏</a>
<!--ID: 1781113785074-->


to open (often to object to spread to open: doors, book, flower) (transitive) #k #card
ほんやく: 開く(ひら)
ます形: 開きます
て形: 開いて
た形: 開いた
...
to open shop / to start business #k #card
店（みせ）を開く（ひら）
...
to hold/host an exebition (open) #k #card
展覧会（てんらんかい）を開く（ひら）
...
the Edo era #k #card
江戸時代(えどじだい)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_江.html">江</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_戸.html">戸</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_時.html">時</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_代.html">代</a>
<!--ID: 1781113785081-->
...
trade #card
貿易(ぼうえき)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_貿.html">貿</a>
...
temple #k #card
寺(てら)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_寺.html">寺</a>
<!--ID: 1781113785085-->
...
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_紀.html">紀</a>
<!--ID: 1781113785086-->
...
grapes #card
葡萄(ぶどう)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_葡.html">葡</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_萄.html">萄</a>
<!--ID: 1781113785088-->


even if / example #card
例え(たとえ)
...
thief #card
泥棒(どろぼう)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_泥.html">泥</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_棒.html">棒</a>
<!--ID: 1781113785091-->
...
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_械.html">械</a>
<!--ID: 1781113785099-->
...
invention / to invent + verb #k #card
発明(はつめい)(する)
...
出す形 (start): 苛め出す
尊敬語 (honorific): 苛められる
お〜になる (honorific): お苛めになる
そう (looks like): 苛めそう
おう (let's): 苛めよう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_苛.html">苛</a>
<!--ID: 1781113785105-->


Japanese sake #k #card
日本酒(にほんしゅ)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_日.html">日</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_本.html">本</a>
...
出す形 (start): 拾い出す
尊敬語 (honorific): 拾われる
お〜になる (honorific): お拾いになる
そう (looks like): 拾いそう
おう (let's): 拾おう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_拾.html">拾</a>
<!--ID: 1781113785107-->


soon 9 o'clock #k #card
そろそろ９時（じ）です
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_時.html">時</a>
<!--ID: 1781113785108-->


i will leave soon #k #card
そろそろ行（い）くわ
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_行.html">行</a>
<!--ID: 1781113785109-->
...
出す形 (start): 怒り出す
尊敬語 (honorific): 怒られる
お〜になる (honorific): お怒りになる
そう (looks like): 怒りそう
おう (let's): 怒ろう
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_怒.html">怒</a>
<!--ID: 1781113785111-->
...
establishment / to establish + verb #k #card
設立(せつりつ)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_設.html">設</a>
...
breakdown / to break down + verb #card
故障(こしょう)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_故.html">故</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_障.html">障</a>
<!--ID: 1781113785116-->
...
rudeness / to be excused + verb #card
失礼(しつれい)(する)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_失.html">失</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_礼.html">礼</a>
<!--ID: 1781113785120-->


expression when you enter a room #card
失礼(しつれい) します
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_失.html">失</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_礼.html">礼</a>
<!--ID: 1781113785121-->
...
expression when you wish to apologize #card
失礼(しつれい) しました
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_失.html">失</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_礼.html">礼</a>
<!--ID: 1781113785122-->
...
when with superior you want to start conversation #card
失礼(しつれい) ですが
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_失.html">失</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_礼.html">礼</a>
<!--ID: 1781113785123-->
...
to think (active mental process, working something out) #card
ほんやく: 考える(かんが)
ます形: 考えます
て形: 考えて
た形: 考えた
...
how large (size) is this ship? #k #card
この船（ふね）の大きさは（おお）どれぐらいありますか
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_船.html">船</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_大.html">大</a>
<!--ID: 1781113785125-->


invitation / to invite + verb (formal) #k #card
招待(しょうたい)(する)
...
happiness / happy (overall fulfillment) #card
幸せ(しあわせ)
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_幸.html">幸</a>
<!--ID: 1781113785130-->
...
How long do you plan to be in Japan? #k #card
どれぐらい — "how much / how long / how many / to what extent"#w どれぐらい日本(にほん)にいる予定(よてい)ですか。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_日.html">日</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_本.html">本</a>
...
I was scolded by my mom #k #card
私（わたし）は母（はは）に叱られました（しか）
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_私.html">私</a>
...
Miss Ando was praised by the general manager. #k #card
安藤(あんどう)さんは部長(ぶちょう)にほめられました。
...
Raj and I were invited to a party by the company president. #k #card
わたしとラジさんは社長(しゃちょう)にパーティーに招待(しょうたい)されました。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_社.html">社</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_長.html">長</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_招.html">招</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_待.html">待</a>
...
I was asked about the way by a stranger just now. #k #card
さっき知(し)らない人(ひと)に道(みち)を聞(き)かれました。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_知.html">知</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_人.html">人</a>
...
The person next to me stepped on my foot on train #k #card
電車（でんしゃ）の中（なか）で私（わたし）はとなりの人（ひと）に足（あし）をふまれました
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_電.html">電</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_車.html">車</a>
...
A: What's wrong with your hand? B: I had my hand bitten by a dog #k #card
A: その手（て）、どうしたの？ B: 犬（犬）に手（て）をかまれちゃった
...
My younger brother had his wallet stolen by a thief. #k #card
弟(おとうと)は泥棒(どろぼう)にさいふを盗(ぬす)まれました。
...
My favorite cake was eaten entirely by my younger sister. #k #card
妹(いもうと)に大好(だいす)きなケーキを全部(ぜんぶ)食(た)べられた。
...
I was praised by the teacher for my composition. #k #card
私(わたし)は先生(せんせい)に作文(さくぶん)を褒(ほ)められた。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_私.html">私</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_先.html">先</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_生.html">生</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_作.html">作</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_文.html">文</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_褒.html">褒</a>
<!--ID: 1781113785145-->


This novel is read all over the world #k #card
この小説（しょうせつ）は世界中（せかいじゅう）で読まれています（よ）
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_小.html">小</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_説.html">説</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_世.html">世</a>
...
The temple was built in the Edo Period. #k #card
この寺(てら)は江戸時代(えどじだい)に建(た)てられました。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_寺.html">寺</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_江.html">江</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_戸.html">戸</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_時.html">時</a>
...
This picture was drawn in the 17th century. #k #card
この絵(え)は17世紀(せいき)に描(か)かれました。
...
When was the telegram invented? #k #card
電報(でんぽう)はいつ発明(はつめい)されたの？
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_電.html">電</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_報.html">報</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_発.html">発</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_明.html">明</a>
...
wine is made from grapes #k #card
ワインは葡萄（ぶどう）から 作られました（つく）
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_葡.html">葡</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_萄.html">萄</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_作.html">作</a>
<!--ID: 1781113785150-->
...
this house is made from wood #k #card
この家（いえ）は木（き）で作られました（つく）
...
Because we still have time left, we can catch train even if we are not in a hurry #k #card
まだ時間（じかん）があるから、急（いそ）がなくても 電車（でんしゃ）に間に合います（まにあいます）
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_時.html">時</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_間.html">間</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_急.html">急</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_電.html">電</a>
...
I will swim even if it is cold #card
寒（さむ）くても泳（およ）ぎます
...
I still have to do homework even though I hate it #k #card
いやでも、宿題（しゅくだい）をやらなくちゃ
...
Even if structure (emphasize no matter what)　more stronger #card
たとえ.... + ても
<!--ID: 1781113785155-->


Even if its rains, I go to school by bicycle (emphasize no matter what) #k #card
たとえ雨（あめ）でも 自転車（じてんしゃ）で学校（がっこう）に行きます（い）
...
No matter what you say to me, my feelings won't change. #k #card
何(なに)を言(い)われても、わたしの気持(きも)ちは変(か)わりません。
...
Mr. Yamada can sing any song. #k #card
山田(やまだ)さんはどんな歌(うた)でも歌(うた)える。
...
No matter what you say, my feelings won't change. #k #card
何(なに)を言(い)われても気持(きも)ちは変(か)わらない。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_何.html">何</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_言.html">言</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_気.html">気</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_持.html">持</a>
...
No matter who I ask, nobody knows the answer. #k #card
誰(だれ)に聞(き)いても答(こた)えがわからない。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_誰.html">誰</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_聞.html">聞</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_答.html">答</a>
<!--ID: 1781113785161-->


Anyone can make mistakes. #k #card
誰(だれ)でも間違(まちが)える。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_誰.html">誰</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_間.html">間</a>
...
No matter when I call, he doesn't answer. #k #card
いつ電話(でんわ)しても出(で)ない。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_電.html">電</a>
...
Please come anytime. #k #card
いつでも来(き)てください。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_来.html">来</a>
<!--ID: 1781113785164-->


I can sing any song. #w どんなに難(むずか)しくても諦(あきら)めない。 - No matter how hard it is, I won't give up. #k #card
どんな歌(うた)でも歌(うた)える。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_歌.html">歌</a>
<!--ID: 1781113785165-->


No matter how much I eat, I don't gain weight. #k #card
いくら食(た)べても太(ふと)らない。
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_食.html">食</a>
...
I'm happy even if I don't have money #k #card
お金がなくても、幸せ（しあわ）です
...
I am going to eat a meal after I finish work #k #card
仕事(しごと)が終(お)わってから、ご飯(はん)を食(た)べます
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_仕.html">仕</a>
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_事.html">事</a>
...
If it rains, I won't go hiking #k #card
雨(あめ)が降(ふ)ったら、ハイキングに行(い)きません
<a href="https://kanji-trainer.org/Mnemonic_phrase/Mnemonic_雨.html">雨</a>
...
When I don't feel well(body condition is bad), I always sleep a lot #k #card
体(からだ)の調子(ちょうし)がわるいとき、いつもたくさん寝(ね)ています
