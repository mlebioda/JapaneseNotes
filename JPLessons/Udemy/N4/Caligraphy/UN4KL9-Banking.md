...
#w この銀行は先月開店しました（ぎんこう、かいてん）- This bank opened last month
...
#w 本を開く（ほん、ひら）- Open the book
#w このドアを開きませんよ（ひら）- This door doesn't open (yo know)

**(あ)**
#w ドアが開く（あく） - door opens (by itself)
#w まどを開ける（あ）- open the window
#wc 開ける（あ）- to open
#wc 開く（あ）- something opens by itself

#w この店は何時に開きますか（みせ、ひら）- What time does this store open? 
#w この店は日曜日も開いていますか（あ）- Is this shop open on sundays too?

**(かい)**
#w 開店（かいてん）- store opening (but also bussines for the customers, like bank,)
...
**(じ)**
#w 自分（じぶん）- oneself
#w 自社（じしゃ）- the company you work for
#w これは自動ドアですか (じどう) - is this an automatic door?
...
**(うご)**
#wc 動く（うご）- move
#w 人が動く（ひと、うご）- people move

**(どう)**
#w 自動車（自動車) - automobile
#w 自動ドア（じどう）-  automatic door 
...
#w 駅長（えきちょう）- station master
#w 駅前（えきまえ）- station square/plac, near/front of 
...
#wc 集まる（あつ）- gather(on their own)
#w 会員を集める（かいいん、あつ）- gather members(zbierać)

#w 学校に集まる（あつ）- gather at school/zebrać się w szkole
#w 先生は学生から旅行のお金を集めています（りょこう、あつ）- The teacher is collecting money from students for their trip
...
#w 貸金/貸し金（かしきん）- loan (2 writtings) (only money)
#w 貸家/貸し家（かしや）- rental house (2 writtings) (some one rents you)

#w 私は貸し家に住んでいます（かしや、す）- I livee in a rental house
#w 日曜日に車を貸してください（か）- Please, lend me car on sunday
#w この近所に貸し家ありませんか（きんじょ、かしや）- Is there a rental house in this neighborhood?
#w 銀行からお金を借りて、弟に貸しました（ぎんこう、か、おとうと、か）- I borrowed money from the bank and lent it to my younger brother
...
#w 借り貸し（か、か）- loan (Borrowing and lending (personal)
#w 父からお金を借りました（か）- I borrowed money from my father

**(かり)**
#w 借り物・借物（かりもの）- borrowed things(2 readings)
#w 会社からお金を借りて、ハワイ旅行に行きました（か、りょこう）- I borrowed money from the company and went on a trip to Hawaii

**(しゃく)**
#w 借金（しゃっきん）- debt
#w 借家（しゃくや）- renatl house (you renting)
...
#w 有り金（ありがね）- money on hand
#w 有り金は多くありません（ありがね、おお）-there is not much money on hand


**(あり)** - often name of the place
#w 有明（ありあけ）- Ariake (name of the area)


**(ゆう)**
#w 有名（ゆうめい）- famous
#w 有利（ゆうり）- advantageous/korzystny
#w 有名な銀行に入りました（ゆうめい、ぎんこう、は）- I joined a famous bank
...
#w この町は名物は少ないです（まち、めいぶつ、すく）- There are few speciality product in this town

**(すこ)**
#w 水を少し入れる（すこ、い）- Add a little water (put in)


**(しょう)**
#w 少々（しょうしょう）- a little (formal, polite)
#w 少年（しょうねん）- boy
...
**(ま)**
#wc 待つ（ま）- to wait
#w 少し待ってください（ま）- Please wait a moment
#w 所長はあなたをお待ちしてます（しょちょう、ま）- the head of the office is waiting for you

**(まち)**
#w 待合室（まちあいしつ）- waiting room

**(たい)**
#w 招待（しょうたい）- invitation
#w 期待（きたい）- expectation
